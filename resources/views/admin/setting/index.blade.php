					...
					<div class="tab-pane" id="general">
						<form data-parsley-validate class="form-horizontal" action="{{ route('admin.settingGeneralRoute', $setting->id) }}" method="post">
							...
							<div class="form-group{{ $errors->has('copyright') ? ' has-error' : '' }}">
								...
								<div class="col-sm-10">
									<input type="text" name="copyright" class="form-control" id="copyright" value="{{ $setting->copyright }}" placeholder="ex. Copyright 2024 BlogMaster, All rights reserved." required maxlength="250">
